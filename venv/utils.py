...
def main_args():
    ...
    parser.add_argument('--csv_file_path', default='images_annotations.csv',
                        help='Type the .csv file name to convert. By default is: images_annotations. '
                             'The converter then will generate test_annotations_images.txt and train_'
                             'annotations_images.txt .')
    parser.add_argument('--annotations', default='no',
                        help='Choose if generate annotated images where:'
